...
func (e *ApplyExecutor) executeOperation(ctx context.Context, op definition.Operation) (*definition.Report, error) {
	switch op.Type {
...
func (e *ApplyExecutor) executeSelect(ctx context.Context, op definition.Operation) (*definition.Report, error) {
...
func (e *ApplyExecutor) executeDML(ctx context.Context, op definition.Operation) (*definition.Report, error) {
...
func (e *ApplyExecutor) validateSelectResult(actual []map[string]interface{}, expected []map[string]interface{}) (bool, string) {
...
func (e *ApplyExecutor) validateDMLResult(actual int64, expected map[string]int, opType string) (bool, string) {
